...
- 3 nodes total: `java.lang.Object` (Primordial) as root, with two children
- 2 edges: `Object → AnalysisClass` and `Object → Main`
- Both application classes inherit directly from `Object` since neither declares an explicit superclass
- Result: ✅ PASS on JDK 17.0.19 (Eclipse Temurin, arm64)
